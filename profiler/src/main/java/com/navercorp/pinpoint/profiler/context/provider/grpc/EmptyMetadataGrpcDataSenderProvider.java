 ...
 * @author jaehong.kim
 */
public class EmptyMetadataGrpcDataSenderProvider implements Provider<EnhancedDataSender<MetaDataType>> {

    @Inject
    public EmptyMetadataGrpcDataSenderProvider(){};

    @Override
    public EnhancedDataSender<MetaDataType> get() {
        return new EmptyDataSender<>();
    }
}